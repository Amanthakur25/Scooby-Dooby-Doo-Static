                ...
                <div className="flex flex-col w-4/5">
                    ...
                    <nav className="bg-gray-200 p-2 rounded-lg">
                        <ul className="flex flex-col md:flex-row md:space-x-4">
                            <li>
                                <Link to="/" className="block cursor-pointer p-2 text-lg text-gray-700 hover:text-orange-800 rounded transition-colors duration-300 relative">
                                    Home
                                </Link>
                            </li>
                            <li>
                                <div className="block p-2 cursor-pointer text-lg text-gray-700 hover:text-orange-800 rounded transition-colors duration-300 relative">
                                    About Us
                                </div>
                            </li>
                            ...
                            <li className="relative group">
                                <div className="block p-2 text-lg cursor-pointer text-gray-700 hover:text-orange-800 rounded transition-colors duration-300 relative">
                                    Gallery
                                </div>
                                <ul className="absolute left-0 hidden text-lg group-hover:block bg-black shadow-lg mt-1 rounded w-40">
                                    <li>
